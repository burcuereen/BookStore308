...
var LayoutsBuilder = (function (_super) {
    __extends(LayoutsBuilder, _super);
    function LayoutsBuilder(hay) {
    ...
    LayoutsBuilder.prototype.parseFile = function (file) {
    ...
    LayoutsBuilder.prototype.removeFile = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            var shortName;
            return __generator(this, function (_a) {
    ...
    LayoutsBuilder.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var files;
            return __generator(this, function (_a) {
    ...
    LayoutsBuilder.prototype.finish = function () {
        this.hay.reporter.finish("<green>\u2713</green>  compiled layouts");
    };
    return LayoutsBuilder;
}(base_1.BaseBuilder));
exports.LayoutsBuilder = LayoutsBuilder;
